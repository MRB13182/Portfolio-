      ...
      >
        ...
        <motion.div
          ...
          className={`relative w-full max-w-4xl max-h-[92vh] rounded-3xl backdrop-blur-2xl border shadow-2xl z-10 overflow-hidden flex flex-col ${
            isDark
              ? 'bg-[rgba(15,15,20,0.96)] border-[rgba(212,175,55,0.35)] text-white shadow-[0_0_80px_rgba(109,40,217,0.35)]'
        ...
        >
          ...
          <div className="p-4 sm:p-5 border-b border-slate-200/70 dark:border-zinc-800/90 flex items-center justify-between gap-4 bg-slate-50/80 dark:bg-[#08080C]/90 backdrop-blur-md shrink-0">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <div className={`hidden sm:inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${
                    isDark ? 'bg-[#6D28D9]/20 text-[#FFD700] border border-[#D4AF37]/30' : 'bg-emerald-50 text-[#00A57A] border border-[#00C896]/30'
                  }`}>
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
              ...
              <div className={`flex items-center rounded-xl border p-1 ${
                isDark ? 'bg-[#121218] border-zinc-800' : 'bg-white border-slate-200'
              }`}>
                <button
                ...
                <span className="px-2 text-[11px] font-mono font-bold text-slate-500 dark:text-zinc-400 select-none">
                ...
                <button
                  ...
                  className={`p-1.5 rounded-lg transition-colors cursor-pointer flex items-center gap-1 text-[11px] font-bold ${
                    isDark ? 'hover:bg-zinc-800 text-[#FFD700]' : 'hover:bg-slate-100 text-[#00A57A]'
                  }`}
                >
              ...
              <button
                ...
                className={`p-2 rounded-xl border transition-colors cursor-pointer ${
                  isDark 
                    ? 'border-zinc-800 bg-[#121218] text-zinc-400 hover:text-white hover:border-[#D4AF37]' 
          ...
          <div 
            ref={containerRef}
            className="flex-grow overflow-auto p-4 sm:p-8 flex items-center justify-center bg-slate-100/60 dark:bg-[#050508]/80 select-none min-h-[340px] sm:min-h-[460px]"
          >
            <div 
              style={{ 
          ...
          <div className="p-3 sm:p-4 border-t border-slate-200/70 dark:border-zinc-800/90 flex flex-col sm:flex-row items-center justify-between gap-2.5 bg-slate-50/90 dark:bg-[#08080C]/90 text-xs shrink-0">
            
            <div className="flex items-center gap-2">
              <span className={`w-2 h-2 rounded-full animate-ping ${
                isDark ? 'bg-[#FFD700]' : 'bg-[#00C896]'
              }`} />
              <span className="font-mono text-slate-500 dark:text-[#A1A1AA] text-[11px]">
                Credential ID: <strong className="text-slate-800 dark:text-zinc-200">{certificate.credentialId}</strong>
              </span>
            </div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className={`inline-flex items-center gap-1.5 text-xs font-bold font-mono transition-colors hover:underline ${
                  isDark ? 'text-[#FFD700] hover:text-white' : 'text-[#00A57A] hover:text-[#007F60]'
                }`}
              >
