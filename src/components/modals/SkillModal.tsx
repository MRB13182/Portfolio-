        ...
        >
          ...
          <div className="flex items-start gap-4 mb-6">
            <div className={`w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 shadow-md ${
              isDark
                ? 'bg-gradient-to-tr from-[#6D28D9] to-[#D4AF37] p-[1.5px]'
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs text-slate-500 dark:text-[#A1A1AA] flex items-center gap-1">
          ...
          <div className="mb-6 p-4 rounded-2xl bg-slate-100/70 dark:bg-[#0B0B0F] border border-slate-200/60 dark:border-[rgba(212,175,55,0.2)]">
            ...
            <div className="w-full h-3 bg-slate-200 dark:bg-zinc-800 rounded-full overflow-hidden p-0.5">
              <motion.div
                initial={{ width: 0 }}
                ...
                className={`h-full rounded-full ${
                  isDark
                    ? 'bg-gradient-to-r from-[#6D28D9] via-[#D4AF37] to-[#FFD700]'
          ...
          {/* Description */}
          <div className="mb-6">
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-[#A1A1AA] mb-2">
              Architecture &amp; Usage
            </h4>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {skill.proficiencyHighlights.map((highlight, idx) => (
                  <div 
                    key={idx}
                    className="flex items-center gap-2 text-xs font-medium text-slate-700 dark:text-zinc-300 bg-slate-50 dark:bg-[#0B0B0F] p-2.5 rounded-xl border border-slate-200/50 dark:border-[rgba(212,175,55,0.2)]"
                  >
          ...
          {skill.projectsUsing && skill.projectsUsing.length > 0 && (
            <div>
              <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-[#A1A1AA] mb-2 flex items-center gap-1.5">
          ...
          {/* Bottom Action */}
          <div className="mt-8 pt-4 border-t border-slate-200/60 dark:border-zinc-800 flex justify-end">
            <button
              onClick={onClose}
