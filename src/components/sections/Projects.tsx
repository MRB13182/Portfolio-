    ...
    <section id="projects" className="relative py-24 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-12">
          <div className="inline-flex items-center gap-2 p-1.5 rounded-2xl border backdrop-blur-md overflow-x-auto max-w-full bg-[rgba(15,15,20,0.85)] border-[rgba(212,175,55,0.25)]">
            {categories.map((cat) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
          {filteredProjects.map((project, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group relative rounded-3xl backdrop-blur-xl border overflow-hidden flex flex-col justify-between transition-all duration-500 cursor-pointer shadow-lg bg-[rgba(15,15,20,0.85)] border-[rgba(212,175,55,0.25)] hover:border-[#D4AF37]/60 hover:shadow-[0_0_30px_rgba(124,58,237,0.25)] text-[#F8FAFC]"
            ...
            >
              ...
              <div className="relative w-full h-52 sm:h-56 overflow-hidden bg-[#0B0B0F]">
                ...
                <div className="absolute top-3.5 left-3.5 z-10">
                  <span className="text-[10px] font-extrabold uppercase tracking-wider px-3 py-1 rounded-full backdrop-blur-md shadow-md bg-[#050505]/85 text-[#FFD700] border border-[#D4AF37]/40">
                    {project.category}
                  </span>
                </div>
                ...
                <div>
                  <div className="flex flex-wrap gap-1.5 mb-5">
                    ...
                    {project.techStack.length > 4 && (
                      <span className="text-[10px] font-mono px-2 py-1 text-[#F8FAFC]">
                        +{project.techStack.length - 4}
                      </span>
                    )}
                  </div>
                  ...
                  {/* Card Footer Actions */}
                  <div className="pt-3 border-t border-[rgba(212,175,55,0.2)] flex items-center justify-between">
