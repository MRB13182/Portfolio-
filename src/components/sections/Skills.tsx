    ...
    <section id="skills" className="relative py-24 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all duration-300 cursor-pointer ${
                    isActive
                      ...
                      : isDark
                        ...
                        : 'bg-white/80 text-slate-700 hover:text-[#00A57A] border border-slate-200 hover:border-[#00C896]'
                  }`}
                >
                  {cat.label}
                </button>
            ...
            <input
              ...
              className={`w-full pl-10 pr-9 py-2.5 rounded-xl text-xs font-medium border focus:outline-none transition-all ${
                isDark
                  ...
                  : 'bg-white/90 border-slate-200 text-slate-900 placeholder-slate-400 focus:border-[#00C896] focus:shadow-[0_2px_12px_rgba(0,200,150,0.2)] focus:ring-1 focus:ring-[#00C896]'
              }`}
            />
            {searchQuery && (
              <button
                ...
                className={`absolute right-3 top-1/2 -translate-y-1/2 ${
                  isDark ? 'text-[#F8FAFC] hover:text-[#FFD700]' : 'text-slate-500 hover:text-slate-900'
                }`}
              >
        ...
        {filteredSkills.length === 0 ? (
          <div className={`text-center py-16 p-8 rounded-3xl border border-dashed ${
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold cursor-pointer ${
                isDark ? 'bg-[#D4AF37] text-black' : 'bg-[#00C896] text-white'
              }`}
            >
              Reset Filters
            </button>
