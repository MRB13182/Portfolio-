...
export const CertificatesShowcase: React.FC<CertificatesShowcaseProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4/5 h-48 blur-3xl opacity-20 pointer-events-none rounded-full bg-gradient-to-r from-[#7C3AED] via-[#D4AF37] to-[#7C3AED]" />

      {/* Section Header */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-10 sm:mb-12 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider mb-3.5 bg-[rgba(124,58,237,0.18)] text-[#D4AF37] border border-[#D4AF37]/35 shadow-[0_0_15px_rgba(212,175,55,0.15)]">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight mb-2">
              Verified{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-[#FFD700] to-[#D4AF37]">
          ...
          <div className="flex items-center gap-2 self-start md:self-auto">
            <div className="p-1 rounded-2xl border flex items-center gap-1 backdrop-blur-2xl bg-[rgba(12,12,16,0.6)] border-[rgba(212,175,55,0.25)]">
              <button
                type="button"
      ...
      {viewMode === 'carousel' && (
        ...
        >
          ...
          <div className="absolute top-0 left-0 bottom-0 w-12 sm:w-32 z-20 pointer-events-none bg-gradient-to-r from-[#050505] via-[#050505]/80 to-transparent" />
          <div className="absolute top-0 right-0 bottom-0 w-12 sm:w-32 z-20 pointer-events-none bg-gradient-to-l from-[#050505] via-[#050505]/80 to-transparent" />
          ...
          <button
            ...
            className="absolute left-4 sm:left-8 top-1/2 -translate-y-1/2 z-30 p-3 rounded-full border shadow-2xl backdrop-blur-2xl transition-all opacity-0 group-hover:opacity-100 cursor-pointer bg-[rgba(12,12,16,0.85)] border-[rgba(212,175,55,0.4)] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black"
          >
          ...
          <button
            ...
            className="absolute right-4 sm:right-8 top-1/2 -translate-y-1/2 z-30 p-3 rounded-full border shadow-2xl backdrop-blur-2xl transition-all opacity-0 group-hover:opacity-100 cursor-pointer bg-[rgba(12,12,16,0.85)] border-[rgba(212,175,55,0.4)] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black"
          >
            ...
            {loopItems.map((cert, loopIndex) => {
              return (
                <div
                  ...
                  className="group/card relative w-[290px] sm:w-[340px] md:w-[370px] shrink-0 rounded-3xl backdrop-blur-2xl border transition-all duration-300 overflow-hidden p-4 sm:p-5 flex flex-col justify-between cursor-pointer hover:-translate-y-2 hover:shadow-2xl bg-[rgba(12,12,16,0.6)] border-[rgba(212,175,55,0.25)] hover:border-[#D4AF37] hover:shadow-[0_0_35px_rgba(212,175,55,0.22)] text-[#F8FAFC]"
                >
                  {/* Real Certificate Image Frame - Sharp, Visible & Primary Focus */}
                  <div className="relative w-full aspect-[1.44/1] rounded-2xl overflow-hidden mb-4 bg-black/60 border border-white/10 shadow-inner flex items-center justify-center">
                    <img 
                      src={cert.image} 
                      alt={cert.title}
                    ...
                    <div className="absolute top-2.5 right-2.5 z-10">
                      <div className="p-1 rounded-full shadow-lg backdrop-blur-md bg-black/70 text-[#FFD700] border border-[#D4AF37]/40">
                  ...
                  <div className="space-y-2 pt-1 border-t border-white/10">
                    <div className="flex items-start justify-between gap-2">
                      <h4 className="text-sm sm:text-base font-extrabold tracking-tight leading-snug text-[#F8FAFC] group-hover/card:text-[#D4AF37] transition-colors line-clamp-2">
                        {cert.title}
                      </h4>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-xs pt-1">
                      {/* Issuer Name & Brand */}
                      <div className="flex items-center gap-1.5 text-[#CBD5E1] font-semibold truncate">
                        <IssuerLogo issuer={cert.issuer || 'Google'} className="w-4 h-4" size={16} />
                        <span className="truncate">{cert.issuer || 'Accredited Issuer'}</span>
                      </div>

                      {/* Verified Badge */}
                      <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-extrabold uppercase font-mono shrink-0 bg-emerald-500/15 text-emerald-400 border border-emerald-500/30">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {filteredCertificates.map((cert, index) => (
              <motion.div
                ...
                className="group/card relative rounded-3xl backdrop-blur-2xl border transition-all duration-300 overflow-hidden p-5 flex flex-col justify-between cursor-pointer hover:-translate-y-2 hover:shadow-2xl bg-[rgba(12,12,16,0.6)] border-[rgba(212,175,55,0.25)] hover:border-[#D4AF37] hover:shadow-[0_0_35px_rgba(212,175,55,0.22)] text-[#F8FAFC]"
              >
                ...
                {/* Bottom Metadata */}
                <div className="space-y-2 pt-1 border-t border-white/10">
                  <h4 className="text-base font-extrabold tracking-tight leading-snug text-[#F8FAFC] group-hover/card:text-[#D4AF37] transition-colors line-clamp-2">
                    {cert.title}
                  </h4>
                  ...
                  <div className="flex items-center justify-between text-xs pt-1">
                    ...
                    <div className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-extrabold uppercase font-mono bg-emerald-500/15 text-emerald-400 border border-emerald-500/30">
                      <CheckCircle2 className="w-3 h-3" />
                      <span>Verified</span>
                    </div>
                  </div>
