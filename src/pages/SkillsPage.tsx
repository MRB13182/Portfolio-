  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col items-center text-center mb-12">
        ...
        <p className="text-slate-600 dark:text-zinc-400 max-w-2xl text-base sm:text-lg leading-relaxed">
      ...
      {filteredSkills.length === 0 ? (
        <div className="text-center py-20 p-8 rounded-3xl border border-dashed border-slate-300 dark:border-zinc-800">
          ...
          {categoryGroups.map((group) => {
            ...
            return (
              <div key={group} className="space-y-4">
                <div className="flex items-center gap-3 border-b border-slate-200/60 dark:border-zinc-800/80 pb-3">
                  <h2 className="text-xl font-black tracking-tight text-slate-900 dark:text-white">
                    {group}
                  </h2>
                  <span className={`text-[10px] font-bold font-mono px-2.5 py-0.5 rounded-full ${
                    isDark ? 'bg-zinc-800 text-[#D4AF37]' : 'bg-emerald-50 text-[#00A57A]'
                  }`}>
