  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col items-center text-center mb-16">
        ...
        <p className="text-[#F8FAFC] max-w-2xl text-base sm:text-lg leading-relaxed mb-6">
        ...
        {onOpenResumeDownload && (
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-bold transition-all border cursor-pointer backdrop-blur-2xl bg-[rgba(12,12,16,0.45)] text-[#D4AF37] border-[#D4AF37]/40 hover:border-[#D4AF37] hover:bg-[rgba(20,20,28,0.7)] shadow-[0_0_15px_rgba(212,175,55,0.2)]"
          >
      ...
      <div className="relative">
        ...
        <div className="absolute left-4 sm:left-1/2 top-4 bottom-4 w-0.5 -translate-x-1/2 rounded-full bg-gradient-to-b from-[#D4AF37] via-[#A855F7] to-[#D4AF37] shadow-[0_0_15px_rgba(212,175,55,0.35)]" />
          ...
          {portfolioConfig.experience.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="p-6 sm:p-7 rounded-3xl backdrop-blur-2xl border transition-all duration-300 hover:shadow-xl bg-[rgba(12,12,16,0.45)] border-[rgba(212,175,55,0.22)] hover:border-[#D4AF37]/60 hover:shadow-[0_0_30px_rgba(124,58,237,0.25)] text-[#F8FAFC]">
                    ...
                    {/* Tech Stack Used */}
                    <div className="pt-3 border-t border-[rgba(212,175,55,0.25)] flex flex-wrap gap-1.5">
